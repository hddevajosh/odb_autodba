---
component_id: 1.1
component_name: Web Interaction Layer
---
...
The primary interface for end-users, responsible for rendering the diagnostic dashboard, managing chat sessions, and visualizing complex Oracle performance data.
...
### /home/neha/projects/agents/odb_autodba/frontend/gradio_app.py (lines 887-895)
```
