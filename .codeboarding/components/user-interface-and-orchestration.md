---
component_id: 1
component_name: User Interface & Orchestration
---
...
The entry point of the system, providing both a Gradio web interface and an 'All-in-One' runner that orchestrates the lifecycle of the UI and background services. It handles user interactions and routes requests to the underlying service layers.
...
- `agents/openai_assistant.py`
- `agents/planner_tool_executor.py`
