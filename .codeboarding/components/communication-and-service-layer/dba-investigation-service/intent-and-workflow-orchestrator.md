---
component_id: 2.2.1
component_name: Intent & Workflow Orchestrator
---
...
The central entry point and controller for the subsystem. It determines the nature of the user's request and manages the high-level execution flow, deciding whether to trigger a standard health check or a deep AI-driven investigation.
